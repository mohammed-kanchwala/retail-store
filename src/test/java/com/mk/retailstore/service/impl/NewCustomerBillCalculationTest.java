...
public class NewCustomerBillCalculationTest extends BillCalculatorTest {

	@Autowired
	private BillCalculator billCalculator;

	@Test
	public void test_calculateNetPayableAmount_New_MultipleCombinations() {
		...
		Customer customer = new Customer("Customer Name", CustomerType.NEW, getDateWithYear(0));
	...
	@Test
	public void test_calculateNetPayableAmount_New_GroceryCombinations() {
		ShoppingCart shoppingCart = new ShoppingCart();
		List<Items> items = new ArrayList<>();
		...
		shoppingCart.setItems(items);
		Customer customer = new Customer("Customer Name", CustomerType.NEW, getDateWithYear(-1));
	...
	@Test
	public void test_calculateNetPayableAmount_New_NonGroceryCombinations() {
		ShoppingCart shoppingCart = new ShoppingCart();
		List<Items> items = new ArrayList<>();
		...
		shoppingCart.setItems(items);
		Customer customer = new Customer("Customer Name", CustomerType.NEW, getDateWithYear(-2));
	...
	@Test
	public void test_calculateNetPayableAmount_New_EmptyShoppingCart() {
		ShoppingCart shoppingCart = new ShoppingCart();
		List<Items> items = new ArrayList<>();

		shoppingCart.setItems(items);
		Customer customer = new Customer("Customer Name", CustomerType.NEW, getDateWithYear(-3));
	...
	@Test
	public void test_calculateNetPayableAmount_New_LessThan100_MultipleCombinations() {
		ShoppingCart shoppingCart = new ShoppingCart();
		List<Items> items = new ArrayList<>();
	...
	@Test
	public void test_calculateNetPayableAmount_New_LessThan100_GroceryCombinations() {
		ShoppingCart shoppingCart = new ShoppingCart();
		List<Items> items = new ArrayList<>();
		items.add(createItemDetails(ItemCategory.GROCERY, 20.00));
		...
		items.add(createItemDetails(ItemCategory.GROCERY, 25.00));
		shoppingCart.setItems(items);
		Customer customer = new Customer("Customer Name", CustomerType.NEW, getDateWithYear(-5));
	...
	@Test
	public void test_calculateNetPayableAmount_New_LessThan100_NonGroceryCombinations() {
		ShoppingCart shoppingCart = new ShoppingCart();
		List<Items> items = new ArrayList<>();
		...
		shoppingCart.setItems(items);
		Customer customer = new Customer("Customer Name", CustomerType.NEW, getDateWithYear(-6));
